                ...
                <div class="content-col">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-4 mt-2">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-floating theme-form-floating-2 search-box">
                                        <div class="form-floating theme-form-floating-2 search-box">
                                            <input type="text" class="form-control" placeholder="Enter price (USD)" id="name" >
                                ...
                                <div class="col-lg-12 mt-5">
                                    <div class="form-floating theme-form-floating-2 search-box">
                                        <div class="form-floating theme-form-floating-2 search-box">
                                            <textarea rows="8" class="form-control" placeholder="Provide a detailed description of the equipment, its condition, and any additional information"></textarea>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row g-sm-4 g-3 row-cols-xxl-5 row-cols-xl-5 row-cols-lg-5 row-cols-md-5 row-cols-2 two_columns">
                                <div>
