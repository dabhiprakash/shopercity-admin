            ...
            <div class="row">
                <div class="col-12">
                    <div class="navbar-top">
                        <div class="navbar-toggler d-inline navbar-menu-button me-2" type="button"
                        ...
                        <div class="rightside-box">
                            <div class="dropdown theme-form-select">
                                <button class="btn dropdown-toggle" type="button" id="" data-bs-toggle="dropdown">
                                    <img src="{{ asset_url('images/product/1.jpg') }}" class="img-fluid" alt="">
