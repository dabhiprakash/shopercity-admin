                ...
                <div class="navbar-top">
                    <div class="d-flex align-items-center" style="column-gap: 10px;">
                        <div class="navbar-toggler d-inline navbar-menu-button me-3" type="button"
                            ...
                            <span class="navbar-toggler-icon">
                                ...
                                <svg width="34" height="25" viewBox="0 0 34 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="34" height="4" rx="2" fill="#FFFFFF"/>
                                    <rect y="10" width="24.2857" height="4" rx="2" fill="#FFFFFF"/>
                                    <rect y="21" width="11.3333" height="4" rx="2" fill="#FFFFFF"/>
                                </svg>
                            </span>
                        </div>
                        ...
                        <a href="{{ url("/") }}" class="web-logo nav-logo">
                            ...
                            <img src="{{ asset_url('images/logo_header.png') }}" class="img-fluid blur-up lazyload mobile_auth_logo" alt="">
                        </a>
                    </div>
                    <div class="rightside-box">
                        <ul class="right-side-menu">
                            <li class="right-side"></li>
                            <li class="right-side"><a href="{{ url("/signup") }}" class="">Sign up</a></li>
                            <li class="right-side">
